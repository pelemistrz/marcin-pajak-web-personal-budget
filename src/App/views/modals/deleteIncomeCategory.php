<div class="modal fade" id="deleteIncomeCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="deleteIncomeCategory" method="POST" action="/settings/deleteincomecategory">
          ...
          <fieldset>
            ...
            <?php foreach ($incomesCategory as $incomeCategory) : ?>
              <div>
                <label>
                  <input type="radio" name="incomeCategoryId" value=" <?php echo e($incomeCategory['id']); ?>" checked />
